...
], path: ".", exclude: ["Package.swift"], sources: ["main.swift", "ReaderNativeMarkdown.swift", "ReaderNativeMathSyntax.swift", "ReaderNativeInlineMedia.swift", "ReaderNativeMediaRoute.swift"])])
