...
], path: ".", exclude: ["Package.swift"], sources: ["main.swift", "ReaderNativeMarkdown.swift", "ReaderNativeMathSyntax.swift", "ReaderNativeInlineMedia.swift", "ReaderNativeMediaRoute.swift", "ReaderNativeAnkiProjection.swift", "ReaderNativeReviewFaces.swift", "ReaderNativeWordCards.swift", "ReaderNativeDataStore.swift", "ReaderNativeLookupRequest.swift"])])
