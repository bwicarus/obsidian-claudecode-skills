...
WINDOWS_SOURCE_FILES = (
    *LAUNCHER_FILES,
    ...
    "ComputerVoiceAudio/ReaderCapabilities/check-report.md",
    ...
    "ComputerVoiceAudio/ReaderCapabilities/research-task.md",
    "ComputerVoiceAudio/ReaderCapabilities/saved-task.md",
    "ComputerVoiceAudio/ReaderCapabilities/task-routing.md",
