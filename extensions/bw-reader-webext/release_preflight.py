...
WINDOWS_SOURCE_FILES = (
    *LAUNCHER_FILES,
    ...
    "ComputerVoiceAudio/DirectAudioPipe.cs",
    ...
    "ComputerVoiceAudio/ReaderAttentionBoard.cs",
    ...
    "ComputerVoiceAudio/ReaderCapabilities/boards.md",
    ...
    "ComputerVoiceAudio/ReaderCapabilities/interactive-paper.md",
    "ComputerVoiceAudio/ReaderCapabilities/navigation.md",
    "ComputerVoiceAudio/ReaderCapabilities/status-report.md",
    "ComputerVoiceAudio/ReaderCapabilities/todo.md",
    "ComputerVoiceAudio/ReaderCapabilities/activity.md",
    "ComputerVoiceAudio/ReaderCapabilities/tool-status.md",
    "ComputerVoiceAudio/ReaderCapabilities/voice-entry.md",
    ...
    "ComputerVoiceAudio/ReplicationCommandIntake.cs",
    "ComputerVoiceAudio/SharedEventDrivenPcmRuntime.cs",
    "ComputerVoiceAudio/UplinkSpeechEndDetector.cs",
    ...
    "computer-voice-desktop/replication_apply.py",
    ...
    "computer-voice-desktop/tests/test_board_card_render.py",
    "computer-voice-desktop/tests/test_bridge_core.py",
    "computer-voice-desktop/tests/test_camera_capture.py",
    "computer-voice-desktop/tests/test_control_plane.py",
    "computer-voice-desktop/tests/test_desktop_launcher.py",
    "computer-voice-desktop/tests/test_judgment_basis.py",
    "computer-voice-desktop/tests/test_readerpc_launcher.py",
    "computer-voice-desktop/tests/test_readerpc_services.py",
    "computer-voice-desktop/tests/test_review_deck.py",
    "computer-voice-desktop/tests/test_situation_actions.py",
    "computer-voice-desktop/tests/test_voice_autoclose.py",
    "computer-voice-desktop/tests/test_voice_conversation_sync.py",
    "computer-voice-desktop/tests/test_codex_restart.py",
    "computer-voice-desktop/tests/test_skill_kit.py",
    "computer-voice-desktop/tests/test_voice_turn_trace.py",
    ...
    "computer-voice-desktop/tests/test_replication_notifications.py",
    "computer-voice-desktop/tests/test_replication_places.py",
    "computer-voice-desktop/tests/test_replication_command_ledger.py",
    "computer-voice-desktop/tests/test_voip_calls.py",
    ...
    "computer-voice-desktop/voice_trace.py",
    "computer-voice-desktop/voice_cli_tab.py",
    "computer-voice-desktop/voice_core_mcp.py",
    "computer-voice-desktop/bw_flow_runner.py",
    "computer-voice-desktop/bw_scheduler.py",
    "computer-voice-desktop/readerpc_api.py",
    "computer-voice-desktop/readerpc_ui/index.html",
    ...
    "tests/test_package_readerpc_server.py",
...
def expected_runtime_js(source_root: Path = HERE) -> tuple[str, ...]:
    ...
    return (
        ...
        "vendor/reader-runtime-anki-mobile-export.js",
