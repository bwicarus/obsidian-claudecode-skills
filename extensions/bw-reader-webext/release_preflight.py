...
WINDOWS_SOURCE_FILES = (
    *LAUNCHER_FILES,
    ...
    "ComputerVoiceAudio/LocalBookPageResolver.cs",
    "ComputerVoiceAudio/LocalBookPageResolverSelfTest.cs",
    "ComputerVoiceAudio/LocalSnapshotPageImageRenderer.cs",
    "ComputerVoiceAudio/LocalSnapshotPageImageRendererSelfTest.cs",
