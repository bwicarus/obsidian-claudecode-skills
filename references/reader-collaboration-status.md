...
- **Windows/验证**：原生桥 `0.1.104` 已原子安装并保持 `active/lastError=null`；同一麦克风代次跨观察窗口未变化，持续运行偏好仍开启；包内自检、Reader Node 990 项、ReaderBundle 与发布管线通过，回退目录 `install-0.1.104-20260812T004037198Z`。
