...
- **两类伪朋友错都防（18 词对抗核验迭代出来的，pv=4）**：
  - (A) 别把**中文同形词才有的义项/贬义**混进来——`下流(かりゅう)` 日语**只有**「下游 / 社会下层」两义，**没有**「粗鄙/下品/猥琐」（那是中文；日语用 `下品/下劣`，kotobank 查 デジタル大辞泉+精選版日本国語大辞典 证实）。
...
**外来语不再显示假的「活用→原形」**（2026-09-04 用户：「既然已经知道来源于非日语那么上方的当前形和原型就很多余」）：
`プライマリー・ヘルス・ケア` 与规范形 `プライマリーヘルスケア` 只差全角中点，那是**写法归一不是活用**，
