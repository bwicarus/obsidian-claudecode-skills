...
(function () {
  ...
  function _applyDebugVisibility() {
    ...
    if (!el) {
      ...
      el.style.cssText = 'position:fixed;left:10px;bottom:calc(10px + env(safe-area-inset-bottom,0px));background:rgba(0,0,0,.85);color:#7be096;font-family:monospace;font-size:11px;padding:8px 12px;border-radius:6px;max-width:600px;max-height:200px;overflow:auto;z-index:240';
