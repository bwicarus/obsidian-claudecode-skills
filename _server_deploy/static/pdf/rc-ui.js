...
(function () {
  ...
  var ICONS = {
    ...
    sparkles:{s:'sparkles',d:'M12 4l1.4 4.2L18 9.6l-4.6 1.4L12 16l-1.4-4.6L6 9.6l4.6-1.4L12 4zM18.6 14.5l.6 1.7 1.7.6-1.7.6-.6 1.7-.6-1.7-1.7-.6 1.7-.6.6-1.7z'},
    money:{s:'dollarsign.circle',d:'M12 3.5a8.5 8.5 0 1 0 0 17 8.5 8.5 0 0 0 0-17zM12 7v10M14.4 9.6c0-1-1.1-1.6-2.4-1.6s-2.4.6-2.4 1.6 1.1 1.5 2.4 1.9 2.4.9 2.4 1.9-1.1 1.6-2.4 1.6-2.4-.6-2.4-1.6'},
    waveform:{s:'waveform',d:'M4 11v2M7.5 8v8M11 4.5v15M14.5 8v8M18 10v4M21 11v2'},
    sync:{s:'arrow.triangle.2.circlepath',d:'M4 9a8 8 0 0 1 13.5-4M20 15A8 8 0 0 1 6.5 19M4 4.5V9h4.5M20 19.5V15h-4.5'},
    mute:{s:'speaker.slash',d:'M4 9.5v5h3.5L12 19V5L7.5 9.5H4zM16.5 9.5l5 5M21.5 9.5l-5 5'},
    sidebar:{s:'sidebar.right',d:'M4 5h16a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1zM15 5v14'},
    camera:{s:'camera',d:'M4 8h3l1.5-2h7L17 8h3a1 1 0 0 1 1 1v9a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V9a1 1 0 0 1 1-1zM12 10.5a3.2 3.2 0 1 0 0 6.4 3.2 3.2 0 0 0 0-6.4z'},
    leaf:{s:'leaf',d:'M5 19c0-8 5-12 14-12 0 9-5 13-11 13-1.5 0-3-.3-3-1zM5 19c2-3 5-5.5 8.5-7'},
    wrench:{s:'wrench',d:'M15.5 3.5a5 5 0 0 0-4.6 6.9L3.5 17.8 6.2 20.5l7.4-7.4A5 5 0 0 0 20.5 8.5l-3 3-2-2 3-3a5 5 0 0 0-3-3z'},
    doc:{s:'doc',d:'M7 3h7l4 4v14H7zM14 3v4h4'},
    ruler:{s:'ruler',d:'M3 14.5L14.5 3l6.5 6.5L9.5 21 3 14.5zM8 9.5l2 2M11 6.5l2 2M5 12.5l2 2'},
    tap:{s:'hand.tap',d:'M9 11V5.5a1.6 1.6 0 1 1 3.2 0V11M12.2 11V9.2a1.5 1.5 0 1 1 3 0V11M15.2 11v-.8a1.5 1.5 0 1 1 3 0V15a5.5 5.5 0 0 1-5.5 5.5h-1A5.7 5.7 0 0 1 6 14.8L5 12.6a1.5 1.5 0 0 1 2.6-1.5L9 13.2'},
    folder:{s:'folder',d:'M3 6.5h6l2 2.5h10v9.5a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V6.5z'},
    key:{s:'key',d:'M14.5 4a5.5 5.5 0 1 0-4.1 9.2L4 19.6 6.4 22l1.6-1.6-1-1 1.9-1.9-1-1 2.5-2.5A5.5 5.5 0 0 0 14.5 4zM15.8 7.8a1.3 1.3 0 1 0 0 2.6 1.3 1.3 0 0 0 0-2.6z'},
